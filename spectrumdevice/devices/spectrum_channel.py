...
class SpectrumChannel(SpectrumChannelInterface):
    ...
    def convert_raw_waveform_to_voltage_waveform(self, raw_waveform: ndarray) -> ndarray:
        vertical_offset_mv = 0.01 * self._vertical_range_mv * self._vertical_offset_in_percent
        return 1e-3 * (self._vertical_range_mv * raw_waveform / self._full_scale_value + vertical_offset_mv)
