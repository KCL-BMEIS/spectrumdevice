...
from spectrum_gmbh.regs import SPC_TIMESTAMP_CMD, SPC_TS_RESET, \
    M2CMD_EXTRA_WAITDMA, SPC_M2CMD, SPC_TS_AVAIL_USER_LEN, SPC_TS_AVAIL_CARD_LEN, SPC_TIMESTAMP_STARTTIME, \
...
from spectrumdevice.settings.timestamps import spectrum_ref_time_to_datetime
...
class Timestamper(ABC):
    ...
    def __init__(self, parent_device: SpectrumDeviceInterface, parent_device_handle: DEVICE_HANDLE_TYPE,
    ...
    def get_timestamps(self) -> List[datetime]:
        ...
        timestamps_in_seconds_since_ref = timestamps_in_samples / self._sampling_rate_hz
