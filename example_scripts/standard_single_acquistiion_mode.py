...
netbox._child_cards[0].set_spectrum_api_param(SPC_50OHM0, 0)
netbox._child_cards[0].set_spectrum_api_param(SPC_50OHM1, 0)
netbox._child_cards[0].set_spectrum_api_param(SPC_50OHM2, 0)
netbox._child_cards[0].set_spectrum_api_param(SPC_50OHM3, 0)
netbox._child_cards[0].set_spectrum_api_param(SPC_50OHM4, 0)
netbox._child_cards[0].set_spectrum_api_param(SPC_50OHM5, 0)
netbox._child_cards[0].set_spectrum_api_param(SPC_50OHM6, 0)
netbox._child_cards[0].set_spectrum_api_param(SPC_50OHM7, 0)

netbox._child_cards[1].set_spectrum_api_param(SPC_50OHM0, 0)
netbox._child_cards[1].set_spectrum_api_param(SPC_50OHM1, 0)
netbox._child_cards[1].set_spectrum_api_param(SPC_50OHM2, 0)
netbox._child_cards[1].set_spectrum_api_param(SPC_50OHM3, 0)
netbox._child_cards[1].set_spectrum_api_param(SPC_50OHM4, 0)
netbox._child_cards[1].set_spectrum_api_param(SPC_50OHM5, 0)
netbox._child_cards[1].set_spectrum_api_param(SPC_50OHM6, 0)
netbox._child_cards[1].set_spectrum_api_param(SPC_50OHM7, 0)
