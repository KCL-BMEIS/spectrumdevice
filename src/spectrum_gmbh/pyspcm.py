...
# from py_header.regs import *  # removed by King's, not needed because regs available in this module

# load registers for easier access
# from py_header.spcerr import *  # removed by King's, not needed because spcerr available in this module
